...
namespace WorkSchedule.DataAccessLayer.Data.Migrations.WorkSchedule
{
    ...
    [Migration("20230204164504_AddAlternateKeyToWorkObject")]
    partial class AddAlternateKeyToWorkObject
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkSchedule.DataAccessLayer.Entities.WorkMonth", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasAlternateKey("Month", "Year", "WorkObjectId");

                    b.HasIndex("WorkObjectId");

                    b.ToTable("WorkMonths", (string)null);
                });
            ...
            modelBuilder.Entity("WorkSchedule.DataAccessLayer.Entities.Schedule", b =>
                {
                    ...
                    b.HasOne("WorkSchedule.DataAccessLayer.Entities.WorkMonth", "WorkMonth")
                        .WithMany("Schedules")
